        ...
        <Flex width={'90%'}
            ...
            <Flex 
              ...
              alignContent={'center'}>
                ...
                alt="Lock"/>
                <p style={{ 'padding-left':'5px'}}>Log in</p>
               
                </Flex>
                <Flex style={{ 'padding-left':'5px','padding-right': '5px'}} >
                    <Button alignContent={'center'} alignItems={'center'} p={'5px'} height={'30px'} color='white' bgColor='#FF6900' variant='solid'>Get a Demo &gt; </Button>
                </Flex>
            </Flex>
        </Flex>
    )
